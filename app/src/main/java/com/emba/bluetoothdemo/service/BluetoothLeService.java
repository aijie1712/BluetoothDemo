package com.emba.bluetoothdemo.service;
...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            DbUtils.save("有需要读入的值：onCharacteristicChanged");
        }
    };

    private int txd_count;

    public void writeStringToGatt(String paramString) {
        if ((paramString != null)) {
            byte[] arrayOfByte = HexUtil.getBytesByString(paramString);
            BluetoothGattCharacteristic localBluetoothGattCharacteristic = this.mBluetoothGatt.getService(UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb")).getCharacteristic(UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb"));
            localBluetoothGattCharacteristic.setValue(arrayOfByte);
            this.mBluetoothGatt.writeCharacteristic(localBluetoothGattCharacteristic);
            this.txd_count += arrayOfByte.length;
            DbUtils.save("发送数据：" + this.txd_count);
        }
    }

    public void writeStringToGatt_1(String paramString) {
        if ((paramString != null)) {
